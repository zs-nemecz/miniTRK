	...
	for acq in ENC REC; do
		for task in OBJ LOC; do 
			for run in 1 2; do 
				...
				currentdesign="/home/mpib/nemecz/Projects/miniTRK/Results/01_MRI/fMRI_Preproc/UNIVAR/GROUP_SPACE/design_files/Preprocess_${participant}_${task}_${acq}_${run}.fsf"
				...
				cp fMRI_Preprocess_UNIVAR_GROUP_SPACE.fsf $currentdesign
				...
				#TODO add more informative job name			
