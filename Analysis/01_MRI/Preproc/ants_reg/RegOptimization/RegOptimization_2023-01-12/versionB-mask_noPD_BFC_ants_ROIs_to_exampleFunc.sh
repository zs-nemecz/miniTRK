...
OUT_PATH='/mnt/fmri_data/miniTRK/Results/01_MRI/ANTS_REG/ROIs/BiasFieldCorrected'
...
for i in `cat $varname`; do
	...
	MOVING_INPUT2=${exampleFunc_PATH}/${i}/${i}_task-OBJ_acq-ENC_run-1.feat/example_func_corrected_brain.nii.gz
...
#	mkdir ${OUT_PATH}/${i}
	...
	-m ${MOVING_INPUT1} \
	-t a \
	-o ${OUT_PATH}/${i}/${VERSION}_${i}_${MOVING1}-To-${FIXED1}_
	...
	-t [${OUT_PATH}/${i}/${VERSION}_${i}_${MOVING1}-To-${FIXED1}_0GenericAffine.mat, 1] \
